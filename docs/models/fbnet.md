...
```python
import timm_new
model = timm_new.create_model('fbnetc_100', pretrained=True)
model.eval()
```
...
```python
model = timm_new.create_model('fbnetc_100', pretrained=True, num_classes=NUM_FINETUNE_CLASSES)
```
...
- Name: fbnetc_100
  ...
  Code: https://github.com/rwightman/pytorch-image-models/blob/9a25fdf3ad0414b4d66da443fe60ae0aa14edc84/timm_new/models/efficientnet.py#L985
